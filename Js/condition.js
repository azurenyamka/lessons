...
// let salary = "";
// let ratePerHour = 28;
// let a = prompt("Та цагаа оруулна уу.");


// if (a <= 40){
//     salary = a * ratePerHour;
//     console.log (salary);
// }
...
let a = parseInt(prompt(Та дурын тоогоо оруулна уу.))
let b = parseInt(prompt(Та дурын тоогоо оруулна уу.))
let c = parseInt(prompt(Та дурын тоогоо оруулна уу.))
